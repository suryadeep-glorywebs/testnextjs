      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Your Brand</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-600 text-sm">Email: info@yourbrand.com</li>
              <li className="text-gray-600 text-sm">Phone: (555) 123-4567</li>
              <li className="text-gray-600 text-sm">Address: 123 Main St, City, State</li>
            </ul>
          </div>
        </div>
